...
procedure TIMPUBM.controllo_campi;
begin
  nome_file_controllo;
end;

procedure TIMPUBM.visualizza_stampa_elabora;
begin

end;

procedure TIMPUBM.FormShow(Sender: TObject);
begin
  inherited;
...
procedure TIMPUBM.v_confermaClick(Sender: TObject);
var
  movmag: tmovmag;
...
procedure TIMPUBM.v_sfogliaClick(Sender: TObject);
begin
  inherited;
...
procedure TIMPUBM.v_tma_codiceExit(Sender: TObject);
begin
  inherited;
  tma_codice_controllo(true);
end;

procedure TIMPUBM.tma_codice_controllo(blocco: boolean);
begin
...
procedure TIMPUBM.v_tmo_codice_caricoExit(Sender: TObject);
begin
  inherited;
  tmo_codice_carico_controllo(true);
end;

procedure TIMPUBM.tmo_codice_carico_controllo(blocco: boolean);
begin
  tabella_controllo(false, tmo_carico, v_tmo_codice_carico, blocco, nil, nil, nil);
end;

procedure TIMPUBM.nome_file_controllo;
begin
...
procedure TIMPUBM.Panel4Enter(Sender: TObject);
begin
  inherited;
  fuoco(v_esci);
end;

procedure TIMPUBM.importa_ubicazioni_da_xls;
var
  movmag: tmovmag;
...
procedure TIMPUBM.aggiorna_ubicazioni(movmag: tmovmag; riga_mmt: integer; art_codice, tub_codice, tipo_movimento: string; quantita: double);
begin
...
function TIMPUBM.controlla_dati(riga: integer): boolean;
begin
  result := true;
