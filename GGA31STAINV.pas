...
procedure TA31STAINV.v_alla_dataExit(Sender: TObject);
begin
  inherited;
  alla_data_controllo;
  if controllo then
...
procedure TA31STAINV.alla_data_controllo;
begin
  inherited;
  if controllo then
  begin
...
procedure TA31STAINV.v_tipo_valorizzazioneExit(Sender: TObject);
begin
  inherited;
  //
end;

procedure TA31STAINV.v_esistenza_zeroExit(Sender: TObject);
begin
  inherited;
  //
end;

procedure TA31STAINV.v_solo_quantitaExit(Sender: TObject);
begin
  inherited;
...
procedure TA31STAINV.controllo_campi;
begin
  alla_data_controllo;
end;

procedure TA31STAINV.FormShow(Sender: TObject);
var
  tag: tmyquery_go;
begin
  inherited;
...
function TA31STAINV.assegna_costo(tipo_valorizzazione: integer): double;
var
...
procedure TA31STAINV.v_confermaClick(Sender: TObject);
var
  prosegui: boolean;
  mmt, lif: tmyquery_go;
begin
...
procedure TA31STAINV.esegue_stampa;
begin
  inherited;
end;

procedure TA31STAINV.FormCreate(Sender: TObject);
begin
...
procedure TA31STAINV.call_selart;
begin
...
procedure TA31STAINV.call_seltma;
begin
...
procedure TA31STAINV.v_selartClick(Sender: TObject);
begin
  inherited;
  call_selart;
end;

procedure TA31STAINV.v_seltmaClick(Sender: TObject);
begin
  inherited;
  call_seltma;
end;

procedure TA31STAINV.v_solo_quantitaClick(Sender: TObject);
begin
  inherited;
  if v_solo_quantita.checked then
  begin
...
procedure TA31STAINV.ppHeaderBand1BeforePrint(Sender: TObject);
begin
  inherited;
  try
...
procedure TA31STAINV.pp_DBText2DrawCommandClick(Sender,
...
procedure TA31STAINV.pp_DBText2DrawCommandCreate(Sender,
  aDrawCommand: TObject);
begin
  inherited;
...
procedure TA31STAINV.ppReportBeforePrint(Sender: TObject);
begin
  inherited;
  try
...
procedure TA31STAINV.FormDestroy(Sender: TObject);
begin
  inherited;
