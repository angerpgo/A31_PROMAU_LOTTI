        ...
        try
          ...
          begin
            ...
            begin
              ...
              query.sql.add('and fvt.tdo_codice not in (select tdo_codice_autofattura from tco)');
            end;
          end;
            ...
            begin
              ...
              begin
                ...
                begin
                  ...
                  tag.close;
                  tag.parambyname('codice').asstring := testata.fieldbyname('tag_codice').asstring;
                  tag.parambyname('tag_codice_ca').asstring := testata.fieldbyname('tag_codice_ca').asstring;
                  tag.open;
                    ...
                    begin
                      ...
                      begin
                        ...
                        begin
                          ...
                          begin
                            pnt.fieldbyname('ritenuta_cliente').asstring := 'si';
                          end;
                          ...
                          //  ritenute clienti
                          if ritenute_clienti and (testata.fieldbyname('importo_ritenuta').asfloat <> 0) then
                          begin
                            read_tabella(ritclit, 0);
                            ritclit.append;
                            ritclit.fieldbyname('progressivo').asinteger := arc.setta_valore_generatore(arc.arcdit, 'RITCLI_PROGRESSIVO');
                            ritclit.fieldbyname('cli_codice').asstring := testata.fieldbyname('cli_codice').asstring;
                            ritclit.fieldbyname('data_documento').asdatetime := testata.fieldbyname('data_documento').asdatetime;
                            ritclit.fieldbyname('serie_documento').asstring := testata.fieldbyname('serie_documento').asstring;
                            ritclit.fieldbyname('numero_documento').asfloat := testata.fieldbyname('numero_documento').asfloat;
                            ritclit.fieldbyname('tpe_codice').asstring := testata.fieldbyname('tpe_codice').asstring;
                            ritclit.fieldbyname('importo_totale_documento').asfloat := testata.fieldbyname('importo_totale').asfloat;
                            ritclit.fieldbyname('importo_ritenuta').asfloat := testata.fieldbyname('importo_ritenuta').asfloat;
                            ritclit.fieldbyname('doc_progressivo_origine').asinteger := pnt.fieldbyname('progressivo').asinteger;
                            ritclit.post;
                          end;
                          ...
                          begin
                            ...
                            begin
                              ...
                              begin
                                ...
                                begin
                                  importo_cambio := arrotonda(importo_cambio * -1);
                                end;
                                ...
                                begin
                                  ...
                                  pnr.fieldbyname('importo_avere_euro').asfloat := 0;
                                ...
                                begin
                                  ...
                                  pnr.fieldbyname('importo_dare').asfloat := 0;
                                  pnr.fieldbyname('importo_dare_euro').asfloat := 0;
                                end;
...
(*
                                if (pnr.fieldbyname('importo_avere').asfloat < 0) or
                                  (pnr.fieldbyname('importo_avere_euro').asfloat < 0) then
                                begin
                                  pnr.fieldbyname('importo_dare').asfloat := pnr.fieldbyname('importo_avere').asfloat * -1;
                                  pnr.fieldbyname('importo_dare_euro').asfloat := pnr.fieldbyname('importo_avere_euro').asfloat * -1;
                                  pnr.fieldbyname('importo_avere').asfloat := 0;
                                  pnr.fieldbyname('importo_avere_euro').asfloat := 0;
                                end
                                else if (pnr.fieldbyname('importo_dare').asfloat < 0) or
                                  (pnr.fieldbyname('importo_dare_euro').asfloat < 0) then
                                begin
                                  pnr.fieldbyname('importo_avere').asfloat := pnr.fieldbyname('importo_dare').asfloat * -1;
                                  pnr.fieldbyname('importo_avere_euro').asfloat := pnr.fieldbyname('importo_dare_euro').asfloat * -1;
                                  pnr.fieldbyname('importo_dare').asfloat := 0;
                                  pnr.fieldbyname('importo_dare_euro').asfloat := 0;
                                end;
*)
                          ...
                          begin
                            ...
                            begin
                              ...
                              if testata.fieldbyname('tipo_documento').asstring = 'nota credito' then
                              begin
                                importo_rata_ritenuta := arrotonda(importo_rata_ritenuta * -1);
                              end;
                              importo_assegnato_ritenuta := arrotonda(importo_assegnato_ritenuta + importo_rata_ritenuta);
                          ...
                          else if testata.fieldbyname('percentuale_ecobonus').asfloat <> 0 then
                          begin
                            read_tabella(arc.arcdit, 'tdo', 'codice', testata.fieldbyname('tdo_codice').asstring, 'tco_codice_ecobonus');
                            read_tabella(arc.arcdit, 'tco', 'codice', archivio.fieldbyname('tco_codice_ecobonus').asstring);
                            pagimm.pagamento_immediato(progressivo_pnt, archivio.fieldbyname('cfg_codice_02').asstring,
                              archivio.fieldbyname('codice').asstring, testata.fieldbyname('data_documento').asstring,
                              arrotonda(testata.fieldbyname('importo_totale').asfloat * testata.fieldbyname('percentuale_ecobonus').asfloat / 100),
                              false, 'no', '');
                          end
                      ...
                      begin
                        ...
                        begin
                          ...
                          begin
                            ...
                            //provvigioni ridotte secondo agente
                            if tag.fieldbyname('imponibile_ridotto_secondo_ca').asstring = 'si' then
                            begin
                              importo_imponibile_provvigioni_ca := arrotonda(importo_imponibile_provvigioni_ca -
                                righe.fieldbyname('importo_percentuale_provvigioni').asfloat);
                            end;
...
registerclass(tcondocv);
                              ...
                              importo_provvigioni_primo_agente := pro.fieldbyname('importo_provvigioni').asfloat;
