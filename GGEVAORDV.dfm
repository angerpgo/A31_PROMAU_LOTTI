inherited EVAORDV: TEVAORDV
  ...
  inherited pannello_parametri: TRzPanel
    ...
    object v_solo_righe_evadibili: TRzCheckBox
      Left = 465
      Top = 340
      Width = 112
      Height = 15
      Hint = 'spunta per evadere solo le righe a saldo'
      Caption = 'solo  righe evadibile'
      State = cbUnchecked
      TabOrder = 23
    end
    object v_escludi_avviamenti: TRzCheckBox
      Left = 466
      Top = 367
      Width = 106
      Height = 15
      Hint = 'spunta per evadere solo le righe a saldo'
      Caption = 'escludi avviamenti'
      Checked = True
      State = cbChecked
      TabOrder = 24
    end
  ...
  inherited ppDBTabella: TppDBPipeline
    ...
    object ppDBTabellappField40: TppField
    ...
    object ppDBTabellappField41: TppField
      FieldAlias = 'arc_codice_articolo_cliente'
      FieldName = 'arc_codice_articolo_cliente'
      FieldLength = 20
      DisplayWidth = 20
      Position = 40
    end
    object ppDBTabellappField42: TppField
      FieldAlias = 'tdo_codice'
      FieldName = 'tdo_codice'
      FieldLength = 4
      DisplayWidth = 4
      Position = 41
    end
  ...
  inherited ppReport: TppReport
    Template.FileName = 'C:\GestionaleOpen\go_utenti\A31_PROMAU\report\EVAORDV_PROM.RTM'
    ...
    inherited ppDetailBand1: TppDetailBand
      ...
      object pp_DBText10: TppDBText
        DesignLayer = ppDesignLayer1
        UserName = 'DBText10'
        OnDrawCommandClick = pp_DBText10DrawCommandClick
        OnDrawCommandCreate = pp_DBText10DrawCommandCreate
        Border.Weight = 1.000000000000000000
  ...
  object tdo_ds: TDataSource
    DataSet = tdo
    Left = 470
    Top = 100
  end
  object ubi: TMyQuery_go
    Connection = ARC.arcdit
    SQL.Strings = (
      'select tub_codice,esistenza'
      'from ubi'
      'where'
