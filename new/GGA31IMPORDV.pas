...
// 02.02.2017 Paolo
//---------------------------------------------------------------------------------
// in fase di gegerazione ordini di c/lavoro a terzi se la distinta
// contiente articolo solo LIVDIST NON SI DEVE GENERARE ORDINE DI CL con
// categoria merceoligca ='ACQ'
//---------------------------------------------------------------------------------
...
uses
  ...
  ZZPROMAU, dxSkinsCore, dxSkinBlack, dxSkinBlue, dxSkinCaramel, dxSkinCoffee, dxSkinDarkRoom,
  ...
  dxSkinsDefaultPainters, dxSkinValentine, dxSkinXmas2008Blue, dxSkinscxPCPainter, ZZTOTACQ, ZZTOTVEN, zzTIPINV,
  ZZPRZINV, ZZCERCA_PREZZO, rzLabel, RzPanel, RzDBEdit, RzListVw, RzTreeVw, RzDBChk,
...
type
  ...
  TA31IMPORDV = class(TELABORA)
    ...
    procedure v_griglia_dbCellClick(Sender: TcxCustomGridTableView;
    ...
    procedure v_griglia_dbqta_01StylesGetContentStyle(Sender: TcxCustomGridTableView;
      ARecord: TcxCustomGridRecord; AItem: TcxCustomGridTableItem; out AStyle: TcxStyle);
    procedure v_griglia_dbqta_02StylesGetContentStyle(Sender: TcxCustomGridTableView;
      ARecord: TcxCustomGridRecord; AItem: TcxCustomGridTableItem; out AStyle: TcxStyle);
    procedure v_griglia_dbqta_03StylesGetContentStyle(Sender: TcxCustomGridTableView;
      ARecord: TcxCustomGridRecord; AItem: TcxCustomGridTableItem; out AStyle: TcxStyle);
    procedure v_griglia_dbqta_04StylesGetContentStyle(Sender: TcxCustomGridTableView;
      ARecord: TcxCustomGridRecord; AItem: TcxCustomGridTableItem; out AStyle: TcxStyle);
    procedure v_griglia_dbqta_05StylesGetContentStyle(Sender: TcxCustomGridTableView;
      ARecord: TcxCustomGridRecord; AItem: TcxCustomGridTableItem; out AStyle: TcxStyle);
    procedure v_griglia_dbqta_06StylesGetContentStyle(Sender: TcxCustomGridTableView;
      ARecord: TcxCustomGridRecord; AItem: TcxCustomGridTableItem; out AStyle: TcxStyle);
    procedure v_griglia_dbqta_07StylesGetContentStyle(Sender: TcxCustomGridTableView;
      ARecord: TcxCustomGridRecord; AItem: TcxCustomGridTableItem; out AStyle: TcxStyle);
    procedure v_griglia_dbqta_08StylesGetContentStyle(Sender: TcxCustomGridTableView;
      ARecord: TcxCustomGridRecord; AItem: TcxCustomGridTableItem; out AStyle: TcxStyle);
    procedure v_griglia_dbqta_09StylesGetContentStyle(Sender: TcxCustomGridTableView;
      ARecord: TcxCustomGridRecord; AItem: TcxCustomGridTableItem; out AStyle: TcxStyle);
    procedure v_griglia_dbqta_10StylesGetContentStyle(Sender: TcxCustomGridTableView;
      ARecord: TcxCustomGridRecord; AItem: TcxCustomGridTableItem; out AStyle: TcxStyle);
    procedure v_griglia_dbqta_11StylesGetContentStyle(Sender: TcxCustomGridTableView;
      ARecord: TcxCustomGridRecord; AItem: TcxCustomGridTableItem; out AStyle: TcxStyle);
    procedure v_griglia_dbqta_12StylesGetContentStyle(Sender: TcxCustomGridTableView;
      ARecord: TcxCustomGridRecord; AItem: TcxCustomGridTableItem; out AStyle: TcxStyle);
    procedure v_griglia_dbqta_13StylesGetContentStyle(Sender: TcxCustomGridTableView;
      ARecord: TcxCustomGridRecord; AItem: TcxCustomGridTableItem; out AStyle: TcxStyle);
    procedure v_griglia_dbqta_14StylesGetContentStyle(Sender: TcxCustomGridTableView;
      ARecord: TcxCustomGridRecord; AItem: TcxCustomGridTableItem; out AStyle: TcxStyle);
    procedure v_griglia_dbqta_15StylesGetContentStyle(Sender: TcxCustomGridTableView;
      ARecord: TcxCustomGridRecord; AItem: TcxCustomGridTableItem; out AStyle: TcxStyle);
  ...
  protected
    ...
    art_codice_spese_extra,
      ...
      art_codice_cassa_professionisti,
      art_codice_sconti_fattura,
      art_codice_sconto_cassa,
      gen_codice_ritenuta,
      tiv_codice_omaggi,
      listini_scaglioni,
      tiv_codice_spese_extra,
      tca_codice_spese_extra,
      tca_codice_trasporto,
      tiv_codice_spese_bollo,
      tca_codice_bollo,
      tiv_codice_spese_incasso,
      tiv_codice_cassa_professionisti,
      tca_codice_cassa_professionisti,
      tca_codice_spese_incasso,
      tca_codice_sconto_cassa,
      tca_codice_sconti_fattura,
      tca_codice,
      tcc_codice,
      tiv_codice,
      gen_codice,
      taq_codice_sconto_cassa,
      taq_codice_sconti_fattura: string;

    tmo_codice_finiti,
      tma_codice_finiti,
      tmo_codice_materie_prime,
      tma_codice_materie_prime,
      tda_codice_produzione_presso_terzi,
      art_codice_sconti_fattura_acq,
      art_codice_sconto_cassa_acq,
      costo_produzione,
      varia_dsb_ordp,
      tipo_esplosione,
      codice_finito: string;
    ...
    procedure crea_distinta_base(tipo_documento, cli_codice, tdo_codice: string; data_documento: tdatetime; ovr_progressivo, ovr_riga, progressivo_origine, riga_origine: integer; art_codice, art_codice_semilavorato: string; quantita: double; data_consegna: tdatetime;
      cms_codice, cmt_codice, nota, opt_ritardo, opt_archivio: string);
    procedure esplosione_distinta(data_documento: tdatetime; ovr_progressivo, ovr_riga, opt_progressivo: integer; tipo_documento, nota, opt_tipo_esplosione, opt_formula, opt_art_codice, opt_tma_codice_finito, opt_frn_codice, opt_ritardo, opt_cms_codice, opt_tipologia,
      opt_tma_codice: string;
      opt_quantita: double;
      opt_data_documento, opt_data_consegna: tdatetime; gg_anticipo: double);
    ...
    procedure genera_sottolivelli(data_documento: tdatetime; opt_tipo_esplosione, semilavorato, art_codice, art_codice_semilavorato, tma_codice, note, cms_codice, tipologia: string; quantita: double; ovr_progressivo, ovr_riga, progressivo_origine, riga_origine: integer;
      data_consegna: tdatetime;
      opt_ritardo: string);
    function costo_unitario(art_codice: string): double;

    procedure crea_ovt(cli_codice, indirizzo, rif_contratto, cms_codice, commessa: string; data_commessa: variant);
    procedure assegna_ovt_indirizzo;
    procedure crea_ovr(progressivo, riga: integer; cms_codice: string);
    procedure crea_dsb(art_codice: string; data_consegna: tdatetime; quantita: double);
    procedure cerca_commessa(var cms_codice: string; tipologia, art_codice, art_descrizione1: string; data_consegna: tdatetime);
    ...
    procedure cancella_ordini_produzione(art_codice, cms_codice: string; posizione: integer);
    procedure cancella_ordini_clienti(cms_codice: string; posizione: integer);
    ...
    procedure assegna_numerazione(connessione: tmyconnection_go; codice_ditta, tipo, serie: string;
      data: tdatetime; var data_precedente: tdatetime; var progressivo, progressivo_precedente: integer;
      aggiorna: boolean; avviso: boolean = true);
    ...
    procedure inserisci_articolo_ordine(tipo_documento, cli_codice, indirizzo, tlv_codice, contratto: string; posizione: integer; art_codice, art_codice_cliente, art_esponente, commessa_cliente: string; data_riferimento: variant; prezzo_speciale: double);
  public
...
procedure TA31IMPORDV.v_griglia_dbCellClick(Sender: TcxCustomGridTableView;
  ACellViewInfo: TcxGridTableDataCellViewInfo; AButton: TMouseButton; AShift: TShiftState;
  var AHandled: Boolean);
var
  Progressivo: integer;
...
procedure TA31IMPORDV.v_griglia_dbqta_01StylesGetContentStyle(Sender: TcxCustomGridTableView;
  ARecord: TcxCustomGridRecord; AItem: TcxCustomGridTableItem; out AStyle: TcxStyle);
var
...
procedure TA31IMPORDV.v_griglia_dbqta_02StylesGetContentStyle(Sender: TcxCustomGridTableView;
  ARecord: TcxCustomGridRecord; AItem: TcxCustomGridTableItem; out AStyle: TcxStyle);
var
  aqta_mod: tcxcustomgridtableitem;
  adata_consegna_mod: tcxcustomgridtableitem;
...
procedure TA31IMPORDV.v_griglia_dbqta_03StylesGetContentStyle(Sender: TcxCustomGridTableView;
  ARecord: TcxCustomGridRecord; AItem: TcxCustomGridTableItem; out AStyle: TcxStyle);
var
  aqta_mod: tcxcustomgridtableitem;
  adata_consegna_mod: tcxcustomgridtableitem;
...
procedure TA31IMPORDV.v_griglia_dbqta_04StylesGetContentStyle(Sender: TcxCustomGridTableView;
  ARecord: TcxCustomGridRecord; AItem: TcxCustomGridTableItem; out AStyle: TcxStyle);
var
  aqta_mod: tcxcustomgridtableitem;
  adata_consegna_mod: tcxcustomgridtableitem;
...
procedure TA31IMPORDV.v_griglia_dbqta_05StylesGetContentStyle(Sender: TcxCustomGridTableView;
  ARecord: TcxCustomGridRecord; AItem: TcxCustomGridTableItem; out AStyle: TcxStyle);
var
  aqta_mod: tcxcustomgridtableitem;
  adata_consegna_mod: tcxcustomgridtableitem;
...
procedure TA31IMPORDV.v_griglia_dbqta_06StylesGetContentStyle(Sender: TcxCustomGridTableView;
  ARecord: TcxCustomGridRecord; AItem: TcxCustomGridTableItem; out AStyle: TcxStyle);
var
  aqta_mod: tcxcustomgridtableitem;
  adata_consegna_mod: tcxcustomgridtableitem;
...
procedure TA31IMPORDV.v_griglia_dbqta_07StylesGetContentStyle(Sender: TcxCustomGridTableView;
  ARecord: TcxCustomGridRecord; AItem: TcxCustomGridTableItem; out AStyle: TcxStyle);
var
  aqta_mod: tcxcustomgridtableitem;
  adata_consegna_mod: tcxcustomgridtableitem;
...
procedure TA31IMPORDV.v_griglia_dbqta_08StylesGetContentStyle(Sender: TcxCustomGridTableView;
  ARecord: TcxCustomGridRecord; AItem: TcxCustomGridTableItem; out AStyle: TcxStyle);
var
  aqta_mod: tcxcustomgridtableitem;
  adata_consegna_mod: tcxcustomgridtableitem;
...
procedure TA31IMPORDV.v_griglia_dbqta_09StylesGetContentStyle(Sender: TcxCustomGridTableView;
  ARecord: TcxCustomGridRecord; AItem: TcxCustomGridTableItem; out AStyle: TcxStyle);
var
  aqta_mod: tcxcustomgridtableitem;
  adata_consegna_mod: tcxcustomgridtableitem;
...
procedure TA31IMPORDV.v_griglia_dbqta_10StylesGetContentStyle(Sender: TcxCustomGridTableView;
  ARecord: TcxCustomGridRecord; AItem: TcxCustomGridTableItem; out AStyle: TcxStyle);
var
  aqta_mod: tcxcustomgridtableitem;
  adata_consegna_mod: tcxcustomgridtableitem;
...
procedure TA31IMPORDV.v_griglia_dbqta_11StylesGetContentStyle(Sender: TcxCustomGridTableView;
  ARecord: TcxCustomGridRecord; AItem: TcxCustomGridTableItem; out AStyle: TcxStyle);
var
  aqta_mod: tcxcustomgridtableitem;
  adata_consegna_mod: tcxcustomgridtableitem;
...
procedure TA31IMPORDV.v_griglia_dbqta_12StylesGetContentStyle(Sender: TcxCustomGridTableView;
  ARecord: TcxCustomGridRecord; AItem: TcxCustomGridTableItem; out AStyle: TcxStyle);
var
  aqta_mod: tcxcustomgridtableitem;
  adata_consegna_mod: tcxcustomgridtableitem;
...
procedure TA31IMPORDV.v_griglia_dbqta_13StylesGetContentStyle(Sender: TcxCustomGridTableView;
  ARecord: TcxCustomGridRecord; AItem: TcxCustomGridTableItem; out AStyle: TcxStyle);
var
  aqta_mod: tcxcustomgridtableitem;
  adata_consegna_mod: tcxcustomgridtableitem;
...
procedure TA31IMPORDV.v_griglia_dbqta_14StylesGetContentStyle(Sender: TcxCustomGridTableView;
  ARecord: TcxCustomGridRecord; AItem: TcxCustomGridTableItem; out AStyle: TcxStyle);
var
  aqta_mod: tcxcustomgridtableitem;
  adata_consegna_mod: tcxcustomgridtableitem;
...
procedure TA31IMPORDV.v_griglia_dbqta_15StylesGetContentStyle(Sender: TcxCustomGridTableView;
  ARecord: TcxCustomGridRecord; AItem: TcxCustomGridTableItem; out AStyle: TcxStyle);
var
  aqta_mod: tcxcustomgridtableitem;
  adata_consegna_mod: tcxcustomgridtableitem;
...
var
  i, j: integer;
  art_codice_finito, cms_codice,
    indirizzo, tlv_codice, tsm_codice,
    tsm_art_codice, testo_messaggio: string;
  prezzo: double;
...
begin
  ...
  query_sor2.sql.add('art_esponente =:art_esponente ');
          ...
          begin
            ...
            begin
              ...
              begin
                ...
                begin
                  testo_messaggio := ' ***** contratto ' + contratto +
                    ' ***** pos. ' + formatfloat('####0', pos_riga) +
                    ' ** codice cliente [ ' + v_cli_codice.text + ' ] ' +
                    ' ** articolo cliente [ ' + art_codice + ' ] non esiste in anagrafica articoli cliente ***** ';

                  inserisci_articolo_log(v_cli_codice.text, contratto, pos_riga, art_codice, '', 'articolo', testo_messaggio);
                end
                else
                begin
                  inserisci_articolo_ordine(tipo_documento, v_cli_codice.text, indirizzo, tlv_codice, contratto, pos_riga, art_codice, '', '', commessa_cliente, data_commessa, prezzo_speciale);
                end;
              ...
              begin
                ...
                begin
                  testo_messaggio := ' ***** contratto ' + contratto +
                    ' ***** pos. ' + formatfloat('####0', pos_riga) +
                    ' ** codice cliente [ ' + v_cli_codice.text + ' ] ' +
                    ' ** articolo cliente [ ' + art_codice + ' ] ' + 'esponente [' + art_esponente + '] non esiste in anagrafica articoli cliente ***** ';

                  inserisci_articolo_log(v_cli_codice.text, contratto, pos_riga, art_codice, art_esponente, 'articolo', testo_messaggio);
                end
                else
                begin
                  inserisci_articolo_ordine(tipo_documento, v_cli_codice.text, indirizzo, tlv_codice, contratto, pos_riga, arc_cli.fieldbyname('art_codice').asstring, art_codice, art_esponente, commessa_cliente, data_commessa, prezzo_speciale);
                end;
  ...
  begin
    ...
    begin
      ...
      query_pos.close;
      query_pos.sql.clear;
      query_pos.sql.add('select distinct tcm_codice, art_codice, contratto, posizione');
      ...
      begin
        // --------------------------------------------------------------
        // modifica promau
        // 24.03.2017 reazione ordini per cat. merc. articolo (AVV/PROD)
        // --------------------------------------------------------------

        cms_codice := cms_codice + ' ' + query_pos.fieldbyname('tcm_codice').asstring;

        scrivi_log('-------------------------------------------------');
        scrivi_log('psozione  ' + query_pos.fieldbyname('posizione').asstring);
        scrivi_log('-------------------------------------------------');
        ...
        // --------------------------------------
        cancella_ordini_produzione(query_pos.fieldbyname('art_codice').asstring, cms_codice, query_pos.fieldbyname('posizione').asinteger);
...
procedure TA31IMPORDV.cancella_ordini_fornitori_terzi(art_codice, cms_codice: string; posizione: integer);
begin
...
procedure TA31IMPORDV.annulla_ordini_fornitori_terzi_parziali(art_codice, frn_codice, cms_codice, cmt_codice: string; data_consegna: tdatetime);
begin
  ...
  begin
    ...
    scrivi_log('frn :' + frn_codice + '  progressivo ' + oar.fieldbyname('progressivo').asstring + ' riga ' + oar.fieldbyname('riga').asstring + ' articolo ' + oar.fieldbyname('art_codice').asstring + ' qta' +
      floattostr(oar.fieldbyname('quantita').asfloat - oar.fieldbyname('quantita_evasa').asfloat) + ' situaz.' +
      oar.fieldbyname('situazione').asstring);
    oar.next;
  end;
...
procedure TA31IMPORDV.cancella_ordini_clienti(cms_codice: string; posizione:
  integer);
var
...
begin
  ...
  sor_articoli.sql.add('ordv.cli_codice <>:cli_codice ');
  sor_articoli.sql.add('order by ordv.tcm_codice,ordv.cli_codice, ordv.indirizzo, ordv.contratto, ordv.posizione, ordv.art_codice, ordv.data_consegna ');
  ...
  begin
    ...
    if rif_contratto <> sor_articoli.fieldbyname('contratto').asstring then
    begin
      ...
      begin
        crea_ovt(sor_articoli.fieldbyname('cli_codice').asstring, sor_articoli.fieldbyname('indirizzo').asstring,
          sor_articoli.fieldbyname('contratto').asstring, rif_contratto,
          sor_articoli.fieldbyname('commessa_cliente').asstring, sor_articoli.fieldbyname('data_commessa').asvariant);
      end;
    ...
    begin
      ...
      if sor_articoli.fieldbyname('cli_codice').asstring <> PROMAU_FRN_CODICE then
      begin
        crea_ovr(ovt.fieldbyname('progressivo').asinteger, riga, rif_contratto);
...
begin
  ...
  begin
    ...
    begin
      disponibilita := (mag_tot.fieldbyname('esistenza').asfloat - mag_tot.fieldbyname('impegnato').asfloat +
        mag_tot.fieldbyname('ordinato').asfloat);
    end;
    ...
    begin
      showmessage(
        'esistenza ' + mag_tot.fieldbyname('esistenza').asstring + #13 + #10 +
        'impegnato ' + mag_tot.fieldbyname('impegnato').asstring + #13 + #10 +
        'ordinato ' + mag_tot.fieldbyname('ordinato').asstring + #13 + #10 +
        'ovr quantita ' + sor_articoli.fieldbyname('quantita').asstring);
    end;
    ...
    begin
      showmessage(
        'quantita ' + floattostr(quantita) + #13 + #10 +
        'disponibilita ' + floattostr(quantita) + #13 + #10);
    end;
    ...
    begin
      ...
      crea_distinta_base(
        ...
        0,
        0,
        sor_articoli.fieldbyname('art_codice').asstring,
        '',
        quantita,
        sor_articoli.fieldbyname('data_consegna').asdatetime,
        sor_articoli.fieldbyname('contratto').asstring,
        sor_articoli.fieldbyname('posizione').asstring,
        'ordine produzione generato da file excel (' + v_nome_file.text,
        'no',
        '');
    end // if
    else
    begin
      crea_distinta_base(
        ...
        sor_articoli.fieldbyname('contratto').asstring,
        sor_articoli.fieldbyname('posizione').asstring,
        'azzero ordine produzione generato da file excel (' + v_nome_file.text,
        'no',
        '');
...
procedure TA31IMPORDV.crea_ovt(cli_codice, indirizzo, rif_contratto, cms_codice, commessa: string;
  data_commessa:
  variant);
var
...
begin
  ...
  begin
    ...
    begin
      ...
      if copy(rif_contratto, length(rif_contratto) - 3, 3) = 'AVV' then
      begin
        read_tabella(arc.arcdit, 'tdo', 'codice', 'ORAV');
      end
      else
      begin
      ...
      assegna_numerazione(arc.arcdit, ditta, 'ORDINI CLIENTI',
        ovt.fieldbyname('serie_documento').asstring, ovt.fieldbyname('data_documento').asdatetime,
        data_precedente, numero_documento, numero_documento_precedente, true);
...
begin
  ...
  sor_articoli.sql.add('data_consegna=:data_consegna');
end;
...
var
  ...
  quantita_prec,
    ...
    importo_iva,
    importo_iva_euro,
    importo_non_arrotondato: double;
...
begin
  ...
  cerca_commessa(
    ...
    sor_articoli.fieldbyname('posizione').asstring,
    sor_articoli.fieldbyname('art_codice').asstring,
    sor_articoli.fieldbyname('art_descrizione1').asstring,
    sor_articoli.fieldbyname('data_consegna').asdatetime);
  ...
  begin
    ...
    begin
      ...
      begin
        prezzo := promau_cerca_prezzo(
          ovt.fieldbyname('cli_codice').asstring,
          ovt.fieldbyname('indirizzo').asstring,
          ovt.fieldbyname('riferimento').asstring,
          ovr_id.fieldbyname('id_origine').asstring,
          ovr_id.fieldbyname('art_codice').asstring,
          ovt.fieldbyname('tlv_codice').asstring,
          tdo.fieldbyname('prezzo_proposto').asstring,
          tipo_documento,
          '',
          cifre_decimali_prezzo,
          tsm_codice,
          tsm_codice_art,
          ovt.fieldbyname('data_documento').asdatetime,
          ovr.fieldbyname('quantita').asfloat);
      end
      else
      begin
      ...
      calcola_importo_documento(
        ovr_id.fieldbyname('quantita').asfloat,
        ovr_id.fieldbyname('prezzo').asfloat,
        ovt.fieldbyname('cambio').asfloat,
        ovr_id.fieldbyname('importo_sconto').asfloat,
        'no',
        ovt.fieldbyname('listino_con_iva').asstring, codice_tum(ovr_id.fieldbyname('art_codice').asstring),
        ovr_id.fieldbyname('tiv_codice').asstring, '', '', importo, importo_euro, importo_iva, importo_iva_euro, importo_non_arrotondato);
      ...
      begin
        ...
        begin
          ...
          begin
            disponibilita := (mag_tot.fieldbyname('esistenza').asfloat - mag_tot.fieldbyname('impegnato').asfloat +
              mag_tot.fieldbyname('ordinato').asfloat + ovr_id.fieldbyname('quantita').asfloat);
          end;
          ...
          begin
            showmessage(
              ...
              'impegnato ' + mag_tot.fieldbyname('impegnato').asstring + #13 + #10 +
              'ordinato ' + mag_tot.fieldbyname('ordinato').asstring + #13 + #10 +
              'ovr quantita ' + ovr_id.fieldbyname('quantita').asstring + #13 + #10);
          end;
        ...
        begin
          ...
          crea_distinta_base(
            'ordine ven',
            ovt.fieldbyname('cli_codice').asstring,
            ovt.fieldbyname('tdo_codice').asstring,
            ovt.fieldbyname('data_documento').asdatetime,
            ovr_id.fieldbyname('progressivo').asinteger,
            ovr_id.fieldbyname('riga').asinteger,
            ovr_id.fieldbyname('progressivo').asinteger,
            ovr_id.fieldbyname('riga').asinteger,
            ovr_id.fieldbyname('art_codice').asstring,
            '',
            quantita,
            ovr_id.fieldbyname('data_consegna').asdatetime,
            ovr_id.fieldbyname('cms_codice').asstring,
            ovr_id.fieldbyname('tipologia').asstring,
            '',
            'no',
            'ordine cliente');
        end;
  ...
  begin
    ...
    crea_distinta_base(
      ...
      quantita,
      sor_articoli.fieldbyname('data_consegna').asdatetime,
      sor_articoli.fieldbyname('cms_codice').asstring,
      sor_articoli.fieldbyname('posizione').asstring,
      '',
      'no',
      'ordine cliente');
...
procedure TA31IMPORDV.crea_dsb(art_codice: string;
  data_consegna:
  tdatetime;
  quantita:
  double);
begin
  ...
  begin
    ...
    begin
      disponibilita := (mag_tot.fieldbyname('esistenza').asfloat - mag_tot.fieldbyname('impegnato').asfloat +
        mag_tot.fieldbyname('ordinato').asfloat + quantita);
    end;
...
procedure TA31IMPORDV.cerca_commessa(
  var
  cms_codice: string;
  tipologia, art_codice, art_descrizione1: string;
  data_consegna: tdatetime);
var
  codice: string;
begin
...
procedure TA31IMPORDV.crea_distinta_base(
  tipo_documento,
  cli_codice,
  tdo_codice: string;
  data_documento:
  ...
  data_consegna:
  tdatetime;
  cms_codice, cmt_codice,
  nota, opt_ritardo, opt_archivio: string);
var
  progressivo: integer;
  gg_anticipo: double;
...
begin
  ...
  begin
    ...
    // 02.02.2017 Paolo
    //
    if (quantita > 0) and (dsb.fieldbyname('art_codice_figlio').asstring <> 'LIVDIST') and (art_finiti.fieldbyname('tcm_codice').asstring <> 'ACQ') then
    begin
      ...
      begin
        ...
        numero_documento_precedente := 0;
        numero_documento := 0;
        assegna_numerazione(arc.arcdit, ditta, 'ORDINI PRODUZIONE', '', date,
          data_precedente, numero_documento, numero_documento_precedente, true);
      ...
      begin
        esplodi_cicli_lavorazione(
          opt.fieldbyname('progressivo').asinteger,
          opt.fieldbyname('art_codice').asstring,
          opt.fieldbyname('quantita').asfloat,
          data_consegna_componenti,
          gg_anticipo);
      end;
    ...
    esplosione_distinta(
      ...
      tipo_esplosione, '',
      art_codice,
      art_finiti.fieldbyname('tma_codice_finiti').asstring,
      frn_codice,
      sor_articoli.fieldbyname('ritardo').asstring,
      cms_codice,
      cmt_codice,
      tma_codice_materie_prime,
      quantita,
...
procedure TA31IMPORDV.esplosione_distinta(
  data_documento: tdatetime;
  ovr_progressivo, ovr_riga, opt_progressivo: integer;
  tipo_documento, nota, opt_tipo_esplosione, opt_formula, opt_art_codice, opt_tma_codice_finito, opt_frn_codice, opt_ritardo, opt_cms_codice, opt_tipologia,
  opt_tma_codice: string;
  opt_quantita:
  double;
  opt_data_documento, opt_data_consegna: tdatetime;
  gg_anticipo:
  double);
var
...
begin
  ...
  begin
    ...
    begin
      ...
      if ((figlio(sor1.fieldbyname('art_codice').asstring, opt_data_documento)) and
        (opt_tipo_esplosione = 'tutti i livelli fino alle materie prime')) or
        (sor1.fieldbyname('art_codice').asstring = opt_art_codice) then
      begin
        solo_materie_prime := false;
        ...
        begin
          ...
          if (dsb.params[0].asstring = opt_art_codice) and
            (opt_formula <> '') and (dsb.fieldbyname('formula').asstring <> '') then
          begin
          ...
          sor1.fieldbyname('quantita').asfloat := arrotonda
            ...
            quantita * dsb.fieldbyname('quantita').asfloat * valore_formula, 4);
          ...
          if (arc.dit.fieldbyname('assegna_costo_gesordp').asstring = 'si') and
            (dsb.fieldbyname('prezzo').asfloat = 0) and (opt_frn_codice = '') then
          begin
      ...
      begin
        // semilavorato
        if (figlio(sor1.fieldbyname('art_codice').asstring, opt_data_documento)) and
          (opt_tipo_esplosione = 'generazione ordini per tutti i semilavorati') then
        begin
          // ------------------------------------------------
          // 03.12.2013 Paolo
  ...
  begin
    ...
    if not(
      ((art.fieldbyname('tipo_articolo').asstring = 'fiscale') and
      (sor1.fieldbyname('quantita').asfloat > 0)) or
      (art.fieldbyname('tipo_articolo').asstring = 'livello distinta')) then
    begin
      salta_articolo := true;
    end;
    ...
    begin
      ...
      begin
        ...
        if (read_tabella(dsb_tma, vararrayof([opt.fieldbyname('art_codice').asstring, opr.parambyname('art_codice').asstring,
          opt.fieldbyname('data_documento').asdatetime, opt.fieldbyname('data_documento').asdatetime]))) and
        ...
        begin
          ...
          begin
            opr.parambyname('quantita').asfloat := arrotonda
  ...
  begin
    ...
    genera_sottolivelli(
      ...
      opt_tipo_esplosione,
      'si',
      query_semilav.fieldbyname('art_codice').asstring,
      query_semilav.fieldbyname('art_codice_finito').asstring,
      opt_tma_codice_finito,
      opr.parambyname('note').asstring,
      opt_cms_codice,
      opt_tipologia,
      query_semilav.fieldbyname('quantita').asfloat,
      ovr_progressivo,
      ovr_riga,
      opr_semilav.fieldbyname('progressivo').asinteger,
      opr_semilav.fieldbyname('riga').asinteger,
      query_semilav.fieldbyname('data_consegna').asdatetime,
      opt_ritardo);
...
function TA31IMPORDV.figlio(art_codice: string;
  data_documento:
  tdatetime): boolean;
begin
  query_figlio.close;
...
begin
  ...
  begin
    ...
    if (art.fieldbyname('tum_codice').asstring <>
      art.fieldbyname('tum_codice_dsb').asstring) and (art.fieldbyname('tum_codice_dsb').asstring <> '') then
    begin

      if art.fieldbyname('operazione_coefficiente_dsb').asstring = '*' then
      begin
        quantita := arrotonda
          (quantita * art.fieldbyname('tum_coefficiente_dsb').asfloat,
          decimali_quantita(art.fieldbyname('tum_codice').asstring));
      end
      else
      begin
...
begin
  ...
  cerca_prezzi.cerca_prezzo('F', art_costo.fieldbyname('frn_codice').asstring, '', 'ultimo prezzo acquisto',
    art_costo.fieldbyname('codice').asstring,
    '', 0, prezzo, tsm_codice, tsm_codice_art,
    data_prezzo, divisa_di_conto, 1,
    cifre_decimali_prezzo_acq, frn_rda.fieldbyname('tla_codice').asstring,
    1, '', art_costo.fieldbyname('tum_codice').asstring);

  if prezzo = 0 then
  begin
    valorizzazione := tipinv.tipo_inventario('gestionale', art_codice);
    przinv.przinv(art_codice, '', valorizzazione,
      esercizio, now, 0, prezzo);
    tsm_codice := '';
    tsm_codice_art := '';
  end;
...
procedure TA31IMPORDV.crea_ordine_lavorazione_presso_terzi(
  frn_codice: string;
  data_consegna:
  tdatetime;
  gg_anticipo:
  ...
  begin
    ...
    begin
      ...
      begin
        ...
        numero_documento := 0;
        numero_documento_precedente := 0;
        assegna_numerazione(arc.arcdit, ditta, 'ORDINI FORNITORI',
          oat.fieldbyname('serie_documento').asstring, oat.fieldbyname('data_registrazione').asdatetime,
          data_precedente, numero_documento, numero_documento_precedente, true);
      ...
      cerca_prezzi.cerca_prezzo('F', oat.fieldbyname('frn_codice').asstring, '', 'listino acquisto', oar.fieldbyname('art_codice').asstring,
        oar.fieldbyname('tma_codice').asstring, 0, prezzo, tsm_codice, tsm_codice_art,
        data_prezzo, oat.fieldbyname('tva_codice').asstring, oat.fieldbyname('cambio').asfloat,
        cifre_decimali_prezzo_acq, oat.fieldbyname('tla_codice').asstring, 1,
      ...
      begin
        ...
        begin
          cerca_prezzi.cerca_prezzo('F', oat.fieldbyname('frn_codice').asstring, '', 'listino acquisto', lavorazioni.fieldbyname('art_codice_figlio').asstring,
            oar.fieldbyname('tma_codice').asstring, 0, prezzo, tsm_codice, tsm_codice_art,
            data_prezzo, oat.fieldbyname('tva_codice').asstring, oat.fieldbyname('cambio').asfloat,
            cifre_decimali_prezzo_acq, oat.fieldbyname('tla_codice').asstring, 1,
            '', oar.fieldbyname('tum_codice').asstring);
...
begin
  if read_tabella(arc.arcdit, 'ind', 'cli_codice;indirizzo',
    vararrayof([ovt.fieldbyname('cli_codice').asstring, ovt.fieldbyname('indirizzo').asstring])) then
  begin
...
begin
  ...
  if ((disponibilita + quantita_da_evadere - quantita) > mag_tot.fieldbyname('scorta_massima').asinteger) and
    (mag_tot.fieldbyname('scorta_massima').asinteger > 0) then
  begin
...
begin
  ...
  *)
  ...
  scrivi_log('---------------------------------------------------------------');
  scrivi_log(
    mag_tot.fieldbyname('esistenza').asstring + #9 + #9 +
    floatTostr(mag_tot.fieldbyname('impegnato').asfloat) + #9 + #9 +
    mag_tot.fieldbyname('ordinato').asstring + #9 + #9 +
    floattostr(disponibilita) + #9 + #9 +
    mag_tot.fieldbyname('scorta_minima').asstring);
...
begin
  ...
  begin
    ...
    try
      ...
      if (tipo = 'DICHIARAZIONI INTRASTAT') or (tipo = 'CONFIGURAZIONE') or
        (tipo = 'FATTURAZIONE ELETTRONICA PA') or (copy(tipo, 1, 7) = 'CFGART-') or
        (tipo = 'REGISTRO COMMERCIALIZZAZIONE') or (copy(tipo, 1, 3) = 'SDA') then
      begin
      ...
      begin
        ...
        begin
          ...
          begin
            if messaggio(304, msg_0019 + ' (' + inttostr(progressivo) + ')' + #13 +
              msg_0020 + ' (' + floattostr(assnum_cnt.fieldbyname('progressivo').asinteger) + ')' + #13 + #13 +
              msg_0021) = 1 then
            begin
          ...
          begin
            if messaggio(304, msg_0019 + ' (' + inttostr(progressivo) + ')' + #13 +
              msg_0022 + ' (' + floattostr(assnum_cnt.fieldbyname('progressivo').asinteger) + ')' + #13 + #13 +
              msg_0023) = 1 then
            begin
              assnum_cnt.fieldbyname('progressivo').asfloat := strtofloat(inttostr(progressivo));
              assnum_cnt.fieldbyname('data_aggiornamento').asdatetime := data;
...
procedure TA31IMPORDV.inserisci_articolo_log(cli_codice, contratto: string;
  posizione:
  integer;
...
procedure TA31IMPORDV.inserisci_articolo_ordine(tipo_documento, cli_codice, indirizzo, tlv_codice, contratto: string;
  posizione: integer;
  art_codice, art_codice_cliente, art_esponente, commessa_cliente: string;
...
begin
  ...
  contratto := contratto + ' ' + archivio.fieldbyname('tcm_codice').asstring;
  ...
  begin
    ...
    begin
      ...
      begin
        flag_aggiungi := false;
        testo_messaggio :=
          ' ***** pos. ' + formatfloat('####0', posizione) +
          ' ** codice cliente [ ' + v_cli_codice.text + ' ] ' +
          ' ** filiale [ ' + indirizzo + ' ] ' +
          ' ** riferimento [ ' + contratto + ' ] ' +
          ' ** articolo cliente [ ' + art_codice_cliente + ' ] - articolo promau [' + art_codice + '] filiale non esiste ***** ';
    ...
    begin
      try
        ...
        testo_messaggio :=
          ...
          ' ** codice cliente [ ' + v_cli_codice.text + ' ] ' +
          ' ** riferimento [ ' + contratto + ' ] ' +
          ' ** articolo cliente [ ' + art_codice_cliente + ' ] - articolo promau [' + art_codice + '] senza prezzo ' + floattostr(prezzo) + ' ***** ';
  ...
  begin
    try
      flag_aggiungi := false;
      testo_messaggio := ' ***** pos. ' + formatfloat('####0', posizione) +
        ' ** codice cliente [ ' + v_cli_codice.text + ' ] ' +
        ' ** articolo cliente [ ' + art_codice_cliente + ' ] - articolo promau [' + art_codice + '] non esiste distinta base ***** ';
    ...
    begin
      ...
      begin
        ...
        begin
          ...
          sor_articoli.fieldbyname('tcm_codice').asstring := archivio.fieldbyname('tcm_codice').asstring;
        ...
        query_sor2.fieldbyname(nome_qta).asfloat := sor_articoli.fieldbyname('quantita').asfloat;
...
begin
  ...
  begin
    ...
    begin
      scrivi_log('evado saldo ordine prod ' + ovr_produzione.fieldbyname('documento_origine').asstring + ' ' + ovr_produzione.fieldbyname('progressivo').asstring + ' ' + ovr_produzione.fieldbyname('art_codice').asstring + ' ' +
        ovr_produzione.fieldbyname('data_consegna').asstring);
