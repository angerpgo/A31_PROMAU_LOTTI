...
begin
  ...
  if v_lotto.text = '' then
  begin
    messaggio(000, 'Codice Collo obbligatorio');
  end
  else
  begin
...
begin
  ...
  try
    try
      ...
      //-----------------------------------------------------------
      crea_movmag_lotto('G-', v_tma_codice.text);
      commit_transazione;
      //-----------------------------------------------------------
      ...
      movmag.riga_mmr := 0;
      //
      crea_movmag_lotto('G+', v_tma_codice_dest.text);
      commit_transazione;
...
procedure TA31GESTRASF.crea_ubm(tmo_codice, art_codice, lotto, tub_codice, tma_codice: string; quantita: double);
var
  progressivo: integer;
begin
  progressivo := 0;
