...
type
  TA31GESTRASF = class(TFORMBASE)
    ...
    v_tub_codice_sorg: trzdbeditdescrizione_go;
    opt: TMyQuery_go;
    xxr: TMyQuery_go;
    v_lotto: trzedit_go;
    ltp: TMyQuery_go;
    ...
    RzLabel6: TRzLabel;
    pannello_ubicazione: TRzPanel;
    RzLabel3: TRzLabel;
    RzLabel7: TRzLabel;
    v_tma_codice_dest: trzdbedit_go;
    v_a31tsu_codice_01_dest: trzdbeditdescrizione_go;
    RzLabel8: TRzLabel;
    v_a31tsu_descrizione_01_dest: trzdbeditdescrizione_go;
    v_a31tsu_codice_02_dest: trzdbeditdescrizione_go;
    v_a31tsu_descrizione_02_dest: trzdbeditdescrizione_go;
    v_a31tsu_codice_03_dest: trzdbeditdescrizione_go;
    v_a31tsu_descrizione_03_dest: trzdbeditdescrizione_go;
    v_a31tsu_codice_04_dest: trzdbeditdescrizione_go;
    v_a31tsu_descrizione_04_dest: trzdbeditdescrizione_go;
    v_a31tsu_codice_05_dest: trzdbeditdescrizione_go;
    v_a31tsu_descrizione_05_dest: trzdbeditdescrizione_go;
    ...
    tub_codice_alternativo: trzdbeditdescrizione_go;
...
procedure TA31GESTRASF.v_aggiungi_lottoClick(Sender: TObject);
begin
  inherited;
  aggiungi_lotto;
end;

procedure TA31GESTRASF.FormCreate(Sender: TObject);
begin
  inherited;
...
procedure TA31GESTRASF.FormDestroy(Sender: TObject);
begin
  inherited;
  movmag.free;
end;

procedure TA31GESTRASF.FormKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
...
procedure TA31GESTRASF.FormShow(Sender: TObject);
begin
  inherited;
...
procedure TA31GESTRASF.set_codice_archivio;
begin
  inherited;
...
procedure TA31GESTRASF.cancella_tabella;
begin
  query.close;
  query.sql.clear;
...
procedure TA31GESTRASF.pulisci_ubicazione;
begin
...
procedure TA31GESTRASF.pulisci_lotto;
begin
...
procedure TA31GESTRASF.cerca_lotto(nome_file: string);
...
procedure TA31GESTRASF.read_lotto_json(lotti_promau: tlotti_promau;
  jsr:
  tjsonreader);
var
  lotto_promau: tlotto_promau;
...
procedure TA31GESTRASF.v_lottoExit(Sender: TObject);
begin
  inherited;
  if v_lotto.text <> '' then
  begin
...
procedure TA31GESTRASF.v_lottoKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
var
  pr: TA31VISLOT;
begin
...
procedure TA31GESTRASF.v_trasferisci_colliClick(Sender: TObject);
begin
  inherited;
  trasferisci_lotto;
end;

procedure TA31GESTRASF.v_tub_codice_destEnter(Sender: TObject);
begin
  inherited;
...
procedure TA31GESTRASF.v_tub_codice_destExit(Sender: TObject);
begin
  inherited;

  if (codice_ubicazione = '') or (pos(#16, codice_ubicazione) > 0) then
  begin
...
procedure TA31GESTRASF.tub_codice_controllo(codice_ubicazione: string);
begin
...
procedure TA31GESTRASF.v_tub_codice_destKeyDown(Sender: TObject; var Key: Word;
  Shift: TShiftState);
begin
  inherited;
  if key = VK_RETURN then
...
procedure TA31GESTRASF.v_tub_codice_destKeyPress(Sender: TObject;
  var Key: Char);
begin
  inherited;
...
procedure TA31GESTRASF.visualizza_lotti(lotti_promau: tlotti_promau);
var
  i: integer;
begin
  v_lista.clear;
...
procedure TA31GESTRASF.aggiungi_lotto;
var
  progressivo: integer;
begin
...
procedure TA31GESTRASF.chiudi_tabelle;
begin
  a31tsu.close;
  lotto_ubi.close;
end;

procedure TA31GESTRASF.tool_genera_lottoClick(Sender: TObject);
begin
  inherited;
  cancella_lotto;
end;

procedure TA31GESTRASF.trasferisci_lotto;
var
...
procedure TA31GESTRASF.crea_movmag_lotto(tmo_codice, tma_codice: string);
var
...
procedure TA31GESTRASF.crea_lotto(tmo_codice, art_codice, lotto, tma_codice: string;
  quantita:
  double);
var
  progressivo: integer;
...
procedure TA31GESTRASF.crea_ubm(tmo_codice, art_codice, lotto, tub_codice, tma_codice: string;
  quantita:
  double);
var
  progressivo: integer;
...
procedure TA31GESTRASF.crea_etichetta(art_codice: string;
  var
  lotto: string;
  tma_codice: string;
  quantita:
...
procedure TA31GESTRASF.cancella_lotto;
begin
